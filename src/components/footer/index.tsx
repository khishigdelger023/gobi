     ...
     <section className='space-y-12'>
       <div className="max-lg:flex lg:grid lg:grid-cols-3 lg:gap-20 gap-12 max-lg:flex-col-reverse">
         <div className='pr-20 space-y-4'>
           ...
           <p className="text-base text-balance">Gobi Cashmere is ... lorem ipsum dolor sit amet, consectetur adipiscing
             elit. Duis
             vestibulum enim vel dapibus commodo. Suspendisse nec pharetra metus. <a href='/' className='underline text-secondaryContent'><br/>Learn More</a></p>
         </div>
         <div className='col-span-2 lg:grid grid-cols-3 gap-6'>
           ...
           <div className='space-y-4'>
             <h3 className="text-xs text-secondaryContent">Let’s keep in touch!</h3>
             <p className="text-sm">Get glowing with our latest products and exclusive events.</p>
             <div className="text-base bg-primary border-b border-baseContent w-full p-2 flex items-center">
               <input type="text" placeholder='Email address' className='w-full bg-primary placeholder:text-secondaryContent flex-1 focus:outline-none focus:ring-0'/>
